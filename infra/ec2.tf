...
resource "null_resource" "configure_nfs" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "sleep 20",
      "cd /app",
      "sudo rm -rf PUC_DevOps",
      "sudo git clone https://github.com/LucasFreitasPro/PUC_DevOps.git",
      "cd PUC_DevOps",
      "sudo docker build -t puc-app-devops:latest .",
      "sudo docker run -d -v /app/PUC_DevOps/app:/usr/share/nginx/html -p 8080:80 puc-app-devops",
    ]
  }
}